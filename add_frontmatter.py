...
files_to_update = [
    ...
    (
        ...
        "Defensive Programming - Detailed Lessons",
        "layouts/base.njk",
        ["lesson", "content"],
    ),
    (
    ...
    (
        ...
        "Third-Party Libraries - Detailed Lessons",
        "layouts/base.njk",
        ["lesson", "content"],
    ),
    (
